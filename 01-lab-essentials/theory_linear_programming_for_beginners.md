...
- практично: если в задаче max ограничение записано как $q(x)\ge0$, используйте $+\lambda q(x)$ при $\lambda\ge0$;
  если как $q(x)\le0$, используйте $-\lambda q(x)$ при $\lambda\ge0$.
