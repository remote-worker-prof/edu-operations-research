...
Именно поэтому ЛР-03 сделана **sensitivity-first**, а не как ещё один длинный tutorial по ручному выводу dual-задачи.
...
в полной dual-модели появляются два типа двойственных переменных:
...
5. Разделение ограничений на `binding` и `slack`.
...
1. Считать, что любое ограничение автоматически влияет на оптимум. Это не так: сначала нужно посмотреть на `slack`.
